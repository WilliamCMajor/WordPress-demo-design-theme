...
//register the widget
add_action( 'widgets_init', 'dc_widget_areas' );
...
if ( ! function_exists( 'dc_widget_areas' ) ) {
	...
	function dc_widget_areas() {
		register_sidebar(
			array(
				'name'          => __( 'Footer one', 'design+code' ),
				'id'            => 'footer-col-one',
				'description'   => __( 'footer-col-one, widget area', 'design+code' ),
        ...
        register_sidebar(
			array(
				'name'          => __( 'Footer two', 'design+code' ),
				'id'            => 'footer-col-two',
				'description'   => __( 'footer column two, widget area', 'design+code' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
        ...
        register_sidebar(
			array(
				'name'          => __( 'Footer three', 'design+code' ),
				'id'            => 'footer-col-three',
				'description'   => __( 'footer column three, widget area', 'design+code' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
        ...
        register_sidebar(
			array(
				'name'          => __( 'Footer four', 'design+code' ),
				'id'            => 'footer-col-four',
				'description'   => __( 'footer column four, widget area', 'design+code' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
        ...
        register_sidebar(
			array(
				'name'          => __( 'Right Sidebar', 'design+code' ),
				'id'            => 'sidebar-primary',
				'description'   => __( 'Right Sidebar, Primary widget area', 'design+code' ),
